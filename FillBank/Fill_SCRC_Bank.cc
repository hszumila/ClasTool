...
// Function Prototype 
void  Fill_SCRC_Bank(TSCRCClass *gcSCRC,SCRC *pSCRC , int nrow, int sector);
...
//cout<<" Time = "<<pSCRC->get_time(nrow)<<" ID = "<<pSCRC->get_id(nrow)<<" ID 1 ="<<gcSCRC->ID<<endl;
